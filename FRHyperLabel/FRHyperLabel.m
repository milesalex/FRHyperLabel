...
+ (void)initialize {
	if (self == [FRHyperLabel class]) {
		FRHyperLabelLinkColorDefault = [UIColor colorWithRed:0.00 green:0.00 blue:0.00 alpha:1.0];
		FRHyperLabelLinkColorHighlight = [UIColor colorWithRed:0.53 green:0.53 blue:0.53 alpha:1.0];
	}
}
